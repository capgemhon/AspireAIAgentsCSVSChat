# Aspire AI Agents Computer System Validation Chat with Custom Data

This project is an AI chat powered by Aspire and Multi Agents in Azure application that demonstrates how to chat with custom data using an AI language model. Please note that this template is currently in an early preview stage. If you have feedback, please take a [brief survey](https://aka.ms/dotnet-chat-templatePreview2-survey).
...
Configure your Azure OpenAI API key and endpoint for this project, using .NET User Secrets:
   ...
   3. In Visual Studio, right-click on the AspireAIAgentsCSVSChat.AppHost project in the Solution Explorer and select "Manage User Secrets".
...
3. Once installed, Open the `Program.cs` file in the AspireAIAgentsCSVSChat.AppHost project.
