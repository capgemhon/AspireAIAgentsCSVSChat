...
namespace AspireAIAgentsCSVSChat.Web.Services.Ingestion;
    ...
    IngestionCacheDbContext ingestionCacheDb)
{
    ...
    {
        var vectorCollection = vectorStore.GetCollection<string, SemanticSearchRecord>("data-aspireaiagentscsvschat-ingested");
